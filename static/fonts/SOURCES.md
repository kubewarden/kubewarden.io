...
The files and provenance below describe the previous Roboto/Poppins typography.
These assets remain available at their original URLs, but the site no longer declares or loads them.
References below to font declarations describe that earlier implementation.
