...
- _Resilience for VEX Hub cache expiration_: We identified and fixed an upstream
...
- _Registry Security Configs_: Restored support for `insecure` and `caBundle` options.
...
- _NATS SecurityContext_: Corrected the _SecurityContext_ in the NATS Helm chart
