...
For a step-by-step guide on using the template, check out our [comprehensive tutorial](https://docs.kubewarden.io/admission-controller/1.38/en/tutorials/writing-policies/typescript/01-intro-typescript.html).
...
We've also created a comprehensive [tutorial](https://docs.kubewarden.io/admission-controller/1.38/en/tutorials/writing-policies/typescript/01-intro-typescript.html) that walks you through building a policy using the template.
